...
namespace ConferenceTracker.Entities
{
    public class Speaker: IValidatableObject 
    {
        ...
        [Display(Name = "First name"), Required, DataType(DataType.Text), StringLength(100,MinimumLength = 2)]
        public string FirstName { get; set; }
        [Display(Name = "Last name"), Required, DataType(DataType.Text), StringLength(100,MinimumLength = 2)]
        public string LastName { get; set; }
        [Required, DataType(DataType.MultilineText), StringLength(500,MinimumLength = 10)]
